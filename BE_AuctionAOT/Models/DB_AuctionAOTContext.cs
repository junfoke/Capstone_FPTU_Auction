...
namespace BE_AuctionAOT.Models
{
    public partial class DB_AuctionAOTContext : DbContext
    {
        ...
        public virtual DbSet<AuctionReviewImage> AuctionReviewImages { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AuctionReview>(entity =>
            {
                ...
                entity.HasOne(d => d.ToUser)
                    .WithMany(p => p.ToUserAuctionReviews)
            ...
            modelBuilder.Entity<AuctionReviewImage>(entity =>
            {
                entity.HasKey(e => e.ImageId);
                ...
                entity.HasOne(e => e.AuctionReview)
                      .WithMany(r => r.Images)
            ...
            modelBuilder.Entity<Post>(entity =>
            {
                ...
                entity.Property(e => e.Title)
                    .HasMaxLength(255)
                    .HasDefaultValueSql("(N'Chưa có tiêu đề')");
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.Property(e => e.IsEkyc).HasDefaultValueSql("((0))");
